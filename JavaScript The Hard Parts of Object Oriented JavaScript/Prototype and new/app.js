...
SOLUTION :-> Store the increment function in just one object and have interpreter, if doesnt't fincd the function on user1, look up to that up to that object if it's there kind of link
...
let user1 = new UserCreator("shahid", 5);
user1.increment();
}

// it's  like stroring this 
// UserCreator  as we know it object as well so, and it's have one property call prototype and it's also a object, and we are storing increment function in it .
//   {prototype : {increment : incremet function} }